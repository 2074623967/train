<template>
  ...
  <div style="border: 4px solid orange; border-radius: 4px; padding: 10px">
    <h3>
    ...
    <li>
      使用<b>第一层验证码</b>，纯前端验证码在前端削弱瞬时高峰，将100毫秒内10万人的请求，分散成1~2秒内10万人请求
    </li>
    <li>
  ...
  <div style="border: 4px solid #99ccff; border-radius: 4px; padding: 10px">
    <h3>
      <b
        >示例网站只开放会员端功能，控台管理暂不开放（怕被乱改车次数据，影响体验）</b
      >
    </h3>
    <div>
      如果您还没有乘车人，可以先去
